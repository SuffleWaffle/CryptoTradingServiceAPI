...
@Injectable()
export class BinanceusService extends TickerService implements OnApplicationBootstrap {
  constructor(readonly redisTicker: RedisTickerService, readonly redisExchange: RedisExchangeService) {
    ...
    this.exchangeId = 'binanceus';
    this.socketAddress = 'wss://stream.binance.us:9443/ws/!ticker@arr';
  }
