...
Libraries are shareable across libraries and applications. They can be imported from `@cupo/mylib`.

## Generate a controller

> nx g @nrwl/nest:module auth --project=api --directory=app/auth --flat --dry-run
>
> nx g @nrwl/nest:service auth --project=api --directory=app/auth --flat --dry-run
>
> nx g @nrwl/nest:controller auth --project=api --directory=app/auth --flat --dry-run

## Generate a service

> nx g @nrwl/nest:service candle-processor --name=CandlesProcessors --project=feeder --directory=app/candles --flat
> --dry-run
